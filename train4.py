...
def plot_history(history, save_path=r"D:\Python\simp\train4.py"):
...
def main():
    data_dir = r"D:\Python\simp\sign4_img"  
    ...
    plot_history(history, save_path=r"D:\Python\simp\train4_plot.png")
